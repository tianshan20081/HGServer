...
/**
 * @author paynet Apr 3, 2014 5:02:21 PM
 * 
 */
public class CreateID {
	...
	// Long _ruleId1 = Long.valueOf(Calendar.getInstance().getTimeInMillis());
	// Integer _ruleId2 = Integer.valueOf(i++);
	// if (i > 99) {
	// i = 10;
	// }
	// return (new Long(_ruleId1.toString() + _ruleId2.toString())).toString();
	// }
